  ...
  */
  ...
  return (
    ...
    <Card data-verification-panel="">
      ...
      {/*
         Boards 4h and 13c. This said *Report an issue* and opened the
         verification policy — prose about how we check a licence, which is not
         what somebody pressing it is trying to do. It opens the report modal
         now, whose first promise is the one this panel's closing sentence
         makes: we check every report against the licence record, and a buyer
         standing in front of the unit knows things we do not.
      */}
