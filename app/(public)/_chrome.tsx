...
import { directoryFooterColumns } from "@/lib/content/directory-footer";
...
/** The ink footer, four columns, from board 1a §8. Its links live in `lib/content/directory-footer.ts`. */
export function DirectoryFooter() {
  const columns = directoryFooterColumns();
