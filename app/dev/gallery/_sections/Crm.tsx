...
const ROWS: CrmRow[] = [
  ...
  // Board 10e B6: searches only, searches with saved alerts waiting, and alerts alone.
  row({
    id: "g-zero-searches",
    displayName: "Gulf Valve House",
    signal: "zero_result",
    claimStatus: "claimed",
    planId: "free",
    facts: { kind: "zero_result", categoryId: "cat-valves", categoryName: "Valves & fittings", searches30d: 6, searchesWeek: 2, alertsWaiting: 0 },
    signalValue: 6,
    demandScore: 6,
    scriptId: "zero_result.v1",
  }),
  row({
    id: "g-zero-both",
    displayName: "Marina Pipe Supply",
    signal: "zero_result",
    claimStatus: "claimed",
    planId: "free",
    facts: { kind: "zero_result", categoryId: "cat-pipes", categoryName: "Pipes & tubing", searches30d: 4, searchesWeek: 1, alertsWaiting: 2 },
    signalValue: 4,
    demandScore: 6,
    scriptId: "zero_result.v1",
  }),
  row({
    id: "g-zero-alerts",
    displayName: "Desert Rose Electrolysis",
    signal: "zero_result",
    claimStatus: "claimed",
    planId: "free",
    facts: { kind: "zero_result", categoryId: "cat-h2", categoryName: "Hydrogen equipment", searches30d: 0, searchesWeek: 0, alertsWaiting: 3 },
    signalValue: 0,
    demandScore: 3,
    scriptId: "zero_result.alerts.v1",
  }),
  row({
    id: "g-technopump",
