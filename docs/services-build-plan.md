...
~~`5c-s` has a labelled placeholder already~~ — **replaced by `5c-s` itself** (§4q): four live
...
## 4q · Handoff `5c-s` — the section library, filtered by trade kind
...
| **4** | The storefront | `1d-s` · `1e-s` · `5c-s` · `1f-s` | Stage 5 | **All four shipped 13 Sep** (§4m–§4o, §4q) — the public storefront set is complete, and the builder's library is filtered by kind |
