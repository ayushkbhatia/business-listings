...
export const en = {
  ...
  */
  ...
  "report_listing.kind_hint.wrong_details": "The number rings a different company, the address is not theirs, the hours are wrong.",
  "report_listing.kind.closed": "The business has closed",
  "report_listing.kind_hint.closed": "The unit is empty, or they have moved and the address still points here.",
  "report_listing.kind.wrong_trade": "It is filed under the wrong trade",
  "report_listing.kind_hint.wrong_trade": "They do not do this work, or the description describes a different business.",
  ...
  "report_listing.field_label": "Which part",
  "report_listing.field_placeholder": "Choose the part",
  "report_listing.choose_kind": "Choose what is wrong first",
  "report_listing.choose_field": "Choose the part",
  ...
  "report_listing.detail_label": "What did you find",
  "report_listing.detail_hint": "At least {min} characters. What you tried, and what happened — a moderator has to be able to check it.",
  "report_listing.submit": "Send the report",
  "report_listing.filed_title": "Report sent",
  "report_listing.filed_body": "A moderator will look at it. We email you when it is decided, whichever way it goes.",
  "report_listing.filed_body_anonymous": "A moderator will look at it. You are not signed in, so there is nowhere for us to write back — sign in before reporting if you want the outcome.",
  "report_listing.next_title": "What happens next",
  "report_listing.next_1": "A moderator reads it, checks it against what we hold, and decides. Most reports end with the supplier correcting the listing.",
  "report_listing.next_2_signed_in": "We email you the outcome. The supplier is never told who reported them.",
  "report_listing.next_2_anonymous": "You are signed out, so there is nowhere for us to send the outcome. The supplier is never told who reported them either way.",
  "report_listing.next_3": "Nothing changes on this page in the meantime. We do not mark a listing as reported.",
  ...
  "report_listing.fix.invalid_kind": "Pick one of the four above.",
  "report_listing.error.invalid_field": "That part does not go with what you picked.",
  "report_listing.fix.invalid_field": "Choose the part from the list under it.",
  "report_listing.error.too_short": "That is too short for a moderator to check.",
  "report_listing.fix.too_short": "Say what you tried and what happened, in a sentence or two.",
  ...
  "report_listing.error.already_reported": "You have already reported this, and it is still open.",
  "report_listing.fix.already_reported": "We will come back to you on the first one. There is nothing to add by sending it twice.",
