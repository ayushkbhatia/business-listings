...
export const en = {
  ...
  */
  ...
  "taxonomy.merge.refusal.storefront_template_conflict": "Both sectors have a live storefront template, and a sector has one. Retire one on the storefront templates screen first.",
  ...
  "taxonomy.refusal.orphan.storefront_templates": { one: "{count} storefront template is built for this sector. Retire it or merge the sector first.", other: "{count} storefront templates are built for this sector. Retire them or merge the sector first." },
  ...
  */
  ...
  "search_blended.tab.all": "All",
  "search_blended.tab.services": "Services",
  "search_blended.tab.businesses": "Businesses",
  ...
  "search_blended.sort_relevant": "Most relevant",
  "search_blended.sort_note": "Services, businesses and products are each ranked on their own and merged by how closely they match what you searched.",
  "search_blended.list_label": "Results",
  "search_blended.kind.service": "Service",
  "search_blended.kind.business": "Supplier",
  ...
  "search_blended.enquire_named": "Enquire about {name}",
  ...
  "search_blended.zero_title": "No results with these filters",
  "search_blended.zero_body": { one: "“{query}” found {formatted} result before the filters on the left.", other: "“{query}” found {formatted} results before the filters on the left." },
  "search_blended.zero_body_no_query": { one: "This search found {formatted} result before the filters on the left.", other: "This search found {formatted} results before the filters on the left." },
  "search_blended.zero_drop": { one: "Clear {facet} — {formatted} result", other: "Clear {facet} — {formatted} results" },
  "search_blended.zero_clear_all": "Clear every filter",
  "search_blended.zero_tab": "Nothing in this tab matches. The other tabs still hold what the search found.",
  ...
  "search_blended.overflow_kind.business": "businesses",
  "search_blended.overflow_kind.product": "products",
  "search_blended.show_more": "Show {count} more",
