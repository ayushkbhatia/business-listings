...
export const en = {
  ...
  */
  ...
  "compare_quotes.message_all.partial": "Sent to {sent} of {total} suppliers. {names} could not take it, because their thread is closed.",
  ...
  "compare_quotes.message_all.error.too_long": "Keep it under {max} characters. A longer specification belongs in a file, attached in a thread.",
