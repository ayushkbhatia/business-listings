...
export const en = {
  ...
  "admin.businesses.state.closing": "Closing",
  "admin.businesses.state.closed": "Closed",
  "admin.businesses.closure.until_notice": "Closes {date}",
  "admin.businesses.closure.until_closing": "Reversible to {date}",
