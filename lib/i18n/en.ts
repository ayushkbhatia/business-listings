...
export const en = {
  ...
  */
  ...
  "matrix.generate_drafts": "Generate {count} drafts",
  ...
  "matrix.drafts_made": "{count} drafts created. They are waiting on a writer.",
  ...
  "matrix.page_of": "Page {page} of {pages}, {total} rows",
  ...
  "rules.subtitle": "Six numbers that decide which pages exist. Every one of them republishes the site.",
  ...
  "rules.pending_counted": "Impact counted {date}, against the data then. It is recounted below, and again at the moment of approval.",
