...
export const en = {
  ...
  */
  ...
  "audit.action.storefront_template_changed": "changed a storefront template",
  ...
  "staff.capability.storefront.template.write": "Edit storefront templates",
  ...
  */
  ...
  "review.error.not_yet_open_short": "Reviews of this engagement open after the first cycle of the work. The accepted record shows the day.",
  "review.error.not_yet_open": "Reviews of this engagement open on {when}, once the first cycle of the work is done. There is nothing to review on day one, so the form waits until then.",
  ...
  */
  ...
  "diff.settings_changed": "{section}: settings changed",
  ...
  "admin.templates.library_count": "{buildable} buildable, {total} in the catalogue, {services} only for firms that sell work.",
  ...
  "section.scope_grid": "Scope grid",
  "section.credential_wall": "Credential wall",
  "section.coverage": "Coverage",
  "section.sectors_served": "Sectors served",
  "section.process_steps": "Process steps",
  ...
  "section.source.scope_grid": "Scope sheets — fee basis and turnaround, per service",
  "section.source.credential_wall": "Credentials — checked ones and the firm's own claims",
  "section.source.coverage": "Coverage — emirates served, per service. Rows, not a map",
  "section.source.sectors_served": "Sectors the firm declared on its profile",
  "section.source.process_steps": "Nothing — somebody would write it here",
  ...
  "section.field.services": "Which services",

  // Board `5c-s` — why a section is not offered, shown on its disabled card (B1).
  "section.unavailable.featured_products": "Nothing to populate it",
  "section.unavailable.catalogue_grid": "Nothing to populate it",
  "section.unavailable.brands": "No stocked brands on a firm that sells work",
  "section.unavailable.certifications": "The credential wall instead",
  "section.unavailable.branches": "Coverage rows instead",
  "section.unavailable.spec_comparison": "No spec sheets on services",
  "section.unavailable.scope_grid": "No scope sheets on product listings",
  "section.unavailable.credential_wall": "Certifications instead",
  "section.unavailable.coverage": "Branches instead",
  "section.unavailable.sectors_served": "Declared by firms that sell work",
  "section.unavailable.process_steps": "No engagements to describe on product listings",
  "section.held.process_steps":
    "Held for a decision: whether steps are written here, with a limit and moderation, or asked on every scope sheet so firms can be compared.",
  "section.available_for.goods": "Product listings",
  "section.available_for.services": "Service listings",
  "section.available_for.both": "Shared",
  ...
  "section.scope_grid.title": "What we do",
  "section.scope_grid.caption": "Services from {name}",
  "section.scope_grid.empty_preview":
    "No services published yet. The grid fills from the seller's scope sheets as each one goes live, one row per service.",
  "section.credential_wall.empty_preview":
    "No credentials added yet. The wall fills from the seller's credentials, and checking one is ours to do, not theirs.",
  "section.credential_wall.none_checked":
    "None of this firm's credentials has been checked yet, and this wall shows checked ones only.",
  "section.coverage.empty_rows_preview":
    "No services published yet, so there are no rows. Each published service brings its own row, from its own coverage or the firm's default.",
  "section.sectors_served.empty_preview": "No sectors declared on the listing profile yet.",
  "section.enquiry.default_intro_services": "Describe the work and when you need it done. They reply with a quote.",
  "section.reviews.title_services": "What clients said",

  // Board `5c-s` — configuration, never content (B2). Closed lists only.
  "section.settings.columns": "Columns",
  "section.settings.columns_hint":
    "Choose which, and move them into place. The headings are ours — a renamed fee basis column is how a fee ends up published under another word.",
  "section.settings.show": "Which credentials",
  "section.settings.show_hint": "A checked credential names who checked it. A claim says it is one.",
  "section.settings.show.all": "Every credential, checked or claimed",
  "section.settings.show.verified": "Only the ones we checked",
  "section.settings.rows": "Rows",
  "section.settings.rows_hint": "Coverage differs by service, so one row per service is what a buyer should read.",
  "section.settings.rows.per_service": "One row per published service",
  "section.settings.rows.union": "One line: everywhere any service reaches",

  // Board `5c-s` — the section library for one template.
  "section.library.title": "Section library",
  "section.library.eyebrow": "{sector} · storefront template",
  "section.library.meta": "Applies to {count} storefronts",
  "section.library.reach_services_only": {
    one: "{formatted} storefront on this template sells only work. It keeps the standard services storefront, so nothing added here changes that page yet.",
    other: "{formatted} storefronts on this template sell only work. They keep the standard services storefront, so nothing added here changes those pages yet.",
  },
  "section.library.nav_label": "Section library",
  "section.library.sections": "Sections",
  "section.library.scope.goods": "Goods",
  "section.library.scope.services": "Services",
  "section.library.scope.both": "Goods and services",
  "section.library.group.services": "For service listings",
  "section.library.group.goods": "For product listings",
  "section.library.group.shared": "Shared",
  "section.library.group.unavailable": "Unavailable here",
  "section.library.on_page": "On the page",
  "section.library.not_offered": "Not offered on this template.",
  "section.library.nothing_selectable":
    "Every section this template could hold is listed with the reason it is not offered.",
  "section.library.preview_of": "Preview · {name}",
  "section.library.settings": "Settings",
  "section.library.add": "Add to page",
  "section.library.add_confirm":
    "Adds {section} to this template, which applies to {count} storefronts. Each one shows it only where it has something to fill it with.",
  "section.library.added": "Added to the template. Each storefront on it shows the section where it has something to fill it with.",
  "section.library.preview_source": "Preview with",
  "section.library.preview_specimen": "The specimen firm",
  "section.library.preview_store.unset": "{name}",
  "section.library.preview_store.goods": "{name} · sells goods",
  "section.library.preview_store.services": "{name} · sells work",
  "section.library.preview_store.both": "{name} · sells both",
  "section.library.preview_as": "Worded for",
  "section.library.as.goods": "A firm that sells goods",
  "section.library.as.services": "A firm that sells work",
  "section.library.preview_show": "Show",
  "section.library.composer_label": "Service enquiry — preview",
  "section.library.note_live_services":
    "The section reads live from the seller's own records. There is no separate content to write here and no way to publish a fee — a builder that let a seller type a price would be the one place on the platform where one appears.",
  "section.library.note_live": "The section reads live from what the listing already holds. There is nothing to write here.",
  "section.library.note_authored":
    "The seller writes this section's words, up to the length each field allows. Anything that reads as a price, a fee or a rate is dropped before it renders — a storefront shows none.",
  "section.library.settings_title": "{section} settings",
  "section.library.settings_body":
    "Configuration only — which rows and which columns, never words. Saving changes all {count} storefronts on this template.",
  "section.library.settings_save": "Save settings",
  "section.library.settings_unchanged": "No changes to save",
  "section.library.settings_saved": "Saved. Every storefront on this template reads the new settings.",
  "section.library.settings_unreadable": "Those settings could not be read. Reload the page and choose them again.",
  "section.library.settings_after_add": "Its settings open here once it is on the template.",
  "section.library.refused_note": {
    one: "{formatted} section is not offered for this trade.",
    other: "{formatted} sections are not offered for this trade.",
  },
  "section.library.open": "See the section library",
