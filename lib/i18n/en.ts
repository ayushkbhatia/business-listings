...
export const en = {
  ...
  "compare.clear": "Clear",
  "compare.full": "Comparison full",
  "compare.page_title": "Compare products",
  "compare.heading": { one: "Comparing {formatted} product", other: "Comparing {formatted} products" },
  "compare.lede": "Rows come from the shared {trade} template, so these are genuinely the same fields — not each seller’s own wording.",
  "compare.lede_no_template": "{trade} has no spec template yet, so there are no shared fields to line up — only availability and how each seller answers.",
  "compare.hide_matching": "Hide matching rows",
  "compare.show_all": "Show every row",
  "compare.print": "Print or save as PDF",
  "compare.export_csv": "Download as CSV",
  "compare.csv.caveat": { one: "{formatted} product in {trade}, field by field, as its seller lists it. Not provided is a gap in a listing, not a difference.", other: "{formatted} products in {trade}, field by field, as each seller lists them. Rows come from the shared template, so these are the same fields. Not provided is a gap in a listing, not a difference." },
  "compare.csv.field": "Field",
  "compare.csv.column": "{product} — {seller}",
  "compare.ask_all": { one: "Ask for a quote", other: "Ask all {formatted} for a quote" },
  "compare.ask_row": "Ask for a quote",
  "compare.caption": { one: "{formatted} product in {trade}, field by field", other: "{formatted} products in {trade}, compared field by field" },
  "compare.caption_differs": { one: "{formatted} product in {trade}, only the rows where it differs", other: "{formatted} products in {trade}, only the rows where they differ" },
  "compare.spec_head": "Spec",
  "compare.row_availability": "Availability",
  "compare.row_reply": "Reply time",
  "compare.row_completeness": "Spec completeness",
  "compare.differs": "differs between these products",
  "compare.summary": { one: "Tinted rows are where these products differ, and {formatted} row decides this. Plain rows match. Not provided is a gap in a listing, not a difference.", other: "Tinted rows are where these products differ, and {formatted} rows decide this. Plain rows match. Not provided is a gap in a listing, not a difference." },
  "compare.summary_none": "Every field these products state reads the same, and so does their availability. The two rows under the line are about the sellers.",
  "compare.summary_no_template": "With no shared template there are no fields to compare. Availability and reply time are the rows every product has.",
  "compare.footnote": "Up to four products · one trade at a time · products only",
  "compare.empty_body": "Tick Compare on up to four products in one trade — from a search, a category or a supplier’s catalogue — and they line up here, field by field.",
  "compare.services_note": "This compares products. A service is compared on the proposals it returns once you send a brief.",
  "compare.browse": "Browse products",
  "compare.need_more": "Add at least one more product in {trade} to compare it with.",
  "compare.notice_delisted": { one: "{formatted} product in this comparison is no longer listed, so it is not in the table.", other: "{formatted} products in this comparison are no longer listed, so they are not in the table." },
  "compare.notice_other_trade": "{name} is in {other}, not {trade}. A comparison holds one trade, so it is not in the table.",
  "compare.notice_overflow": { one: "This link names {formatted} more product than a comparison holds. The first four are shown.", other: "This link names {formatted} more products than a comparison holds. The first four are shown." },
  "compare.tray_label": "Comparison tray",
  "compare.tray_heading": "Comparing {count} of {max} · {trade}",
  "compare.open_count": { one: "Compare {count} product", other: "Compare {count} products" },
  "compare.need_one_more": "Add one more product in {trade} to compare.",
  "compare.notice_replaced": { one: "Started a new comparison in {trade}. The product from before was cleared.", other: "Started a new comparison in {trade}. The {count} products from before were cleared." },
  "compare.notice_unavailable": "That product is no longer listed, so it was not added.",
  "compare.tick_switch": { one: "Starts a new comparison. Your tray holds {count} product in {trade}, which will be cleared.", other: "Starts a new comparison. Your tray holds {count} products in {trade}, which will be cleared." },
  "compare.tick_full": "The comparison holds four already: {names}. Remove one to add this.",
  ...
  "admin.overview.sla": "Service level, in days: moderation {moderation}, claims {claim}, reports {reportFast} to {report} depending on the type, failed payments {dunning}.",
  ...
  "console.metric.reports": "Reports and flags waiting",
  ...
  */
  ...
  "admin.reports.note": "Every decision carries a written reason and an audit row. Suspending an account and closing a listing are ops-lead decisions taken on the account itself, not here: a row that needs one is escalated.",
  ...
  "admin.reports.col.owner": "Owner",
  "admin.reports.col.action": "Next step",
  "admin.reports.col.more": "More",
  "admin.reports.type.off_platform_payment": "Off-platform payment",
  "admin.reports.type.accepted_quote": "After an accepted quote",
  "admin.reports.type.review_dispute": "Review dispute",
  "admin.reports.type.review_integrity": "Review integrity",
  "admin.reports.type.content": "Content",
  "admin.reports.type.wrong_details": "Wrong details",
  "admin.reports.type.closed": "Closed down",
  "admin.reports.type.wrong_trade": "Wrong trade",
  "admin.reports.type.claim_conflict": "Claim conflict",
  "admin.reports.detector.off_platform_message": "Found in a message",
  "admin.reports.detector.shared_phone": "Found by the shared-number sweep",
  "admin.reports.detector.licence_long_expired": "Found by the licence sweep",
  "admin.reports.reporter.public": "Public",
  "admin.reports.reporter.buyer": "A buyer",
  "admin.reports.reporter.seller": "The supplier",
  "admin.reports.reporter.staff": "Our own finding",
  "admin.reports.duplicates": "and {n} more on the same thing",
  "admin.reports.evidence.separate": "{count} separate reports",
  "admin.reports.evidence.priors": "{count} reports of this field",
  "admin.reports.no_claim": "Nothing was written with this report.",
  "admin.reports.sla.late": "Over {sla}",
  "admin.reports.sla.due": "Due within {sla}",
  "admin.reports.sla.ok": "Inside {sla}",
  "admin.reports.action.investigate": "Investigate",
  "admin.reports.action.review": "Review",
  "admin.reports.action.check": "Check",
  "admin.reports.escalated": "Escalated",
  "admin.reports.suspended": "Account suspended",
  "admin.reports.unassigned": "Nobody",
  "admin.reports.reassign": "Hand this to somebody",
  "admin.reports.row_menu": "More for the report about {business}",
  "admin.reports.assign_heading": "Who is working the report about {business}?",
  "admin.reports.assign_to": "Owner",
  "admin.reports.assign_placeholder": "Choose who takes it",
  "admin.reports.unassign": "Take the owner off",
  "admin.reports.assign_confirm": "Set the owner",
  "admin.reports.over_sla": { one: "{n} over its service level", other: "{n} over their service level" },
  "admin.reports.records": { one: "{n} record behind them", other: "{n} records behind them" },
  "admin.reports.all_rows": "Everything",
  "admin.reports.assigned_to_me": "Assigned to me",
  "admin.reports.tune": "Detection thresholds",
  "admin.reports.chips_label": "Filter by type",
  "admin.reports.sort": "Over service level first, then oldest",
  "admin.reports.rail_label": "Outcomes and the rules behind them",
  "admin.reports.chip.all": "All {n}",
  "admin.reports.chip.off_platform_payment": "Off-platform {n}",
  "admin.reports.chip.accepted_quote": "After a quote {n}",
  "admin.reports.chip.review_dispute": "Review disputes {n}",
  "admin.reports.chip.review_integrity": "Review integrity {n}",
  "admin.reports.chip.content": "Content {n}",
  "admin.reports.chip.wrong_details": "Wrong details {n}",
  "admin.reports.chip.closed": "Closed down {n}",
  "admin.reports.chip.wrong_trade": "Wrong trade {n}",
  "admin.reports.chip.claim_conflict": "Claim conflicts {n}",
  "admin.reports.chip.escalated": "Escalated {n}",
  /* Board 13c — three separate sources about one value flag a listing. */
  "admin.reports.chip.flagged": "Flagged {n}",
  "admin.reports.flagged": "Flagged · {sources} sources",
  "admin.reports.flagged_spread": "Flagged · {sources} sources · {listings} listings",
  "admin.reports.filtered_empty.title": "Nothing under this filter",
  "admin.reports.filtered_empty.body": { one: "{n} report is waiting under another type.", other: "{n} reports are waiting under other types." },
  "admin.reports.filtered_empty.back": "Show everything",

  /* ── Board 4h · outcomes, 90 days ───────────────────────────────────────── */
  "admin.reports.outcomes.title": "Outcomes · {days} days",
  "admin.reports.outcomes.none": "Nothing has been decided in {days} days. The shares appear once something has.",
  "admin.reports.outcomes.caption": "How the {count} complaints decided in the last {days} days ended",
  "admin.reports.outcomes.col_outcome": "Outcome",
  "admin.reports.outcomes.col_share": "Share",
  "admin.reports.outcomes.median": "Median time to decide",
  "admin.reports.outcomes.median_none": "Not measured yet",
  "admin.reports.outcomes.note": "Counted from the {count} decisions in the window, not from a target.",
  "admin.reports.outcomes.disputes_note": "{count} of them are review disputes: upheld removes the review, refused leaves it standing.",
  "admin.reports.outcome_long.seller_corrected": "Seller corrected the listing",
  "admin.reports.outcome_long.upheld": "Upheld, content removed",
  "admin.reports.outcome_long.no_action": "No action needed",
  "admin.reports.outcome_long.duplicate": "The same thing, reported again",
  "admin.reports.outcome.duplicate": "Duplicate",

  /* ── Board 4h · the review-integrity rules (B1) ─────────────────────────── */
  "admin.reports.rules.title": "When a review comes down",
  "admin.reports.rules.ground.no_traceable_enquiry": "The enquiry behind it does not describe a real trade with this supplier.",
  "admin.reports.rules.ground.abuse": "Judged on the text: what it says about the people, not about the work.",
  "admin.reports.rules.ground.private_information": "Judged on what the text contains about somebody else — a name, a number, an address.",
  "admin.reports.rules.ground.provably_false": "A factual claim the record contradicts, not an opinion somebody disagrees with.",
  "admin.reports.rules.not_a_ground": "“It is unfair” is not a ground. A reply the buyer and every later reader can see answers that better than a removal.",
  "admin.reports.rules.audit": "These four are the reason the ratings are worth anything. Every removal is logged with the actor, the ground and the evidence.",
  "admin.reports.rules.audit_link": "Read the removals in the audit log",

  /* ── Board 4h · the incentivised-review log (B9, 11c B6) ────────────────── */
  "admin.reports.incentives.title": "Incentivised reviews",
  "admin.reports.incentives.description": "One record per finding, against the account. Every review request says an incentivised review is removed and logged; this is the log.",
  "admin.reports.incentives.none": "No findings on record.",
  "admin.reports.incentives.removed": "Review removed",
  "admin.reports.incentives.standing": "Review still standing",
  "admin.reports.incentives.count": { one: "{n} finding on record.", other: "{n} findings on record." },
  "admin.reports.incentives.link": "Log a finding on the reviews screen",

  /* ── Board 4h · what a write says back ──────────────────────────────────── */
  "admin.reports.resolved_with_duplicates": { one: "Resolved, and {count} duplicate closed with it.", other: "Resolved, and {count} duplicates closed with it." },
  "admin.reports.assigned": "Owner set.",
  "admin.reports.unassigned_done": "Owner removed.",
  "admin.reports.escalated_done": "Escalated. It stays open and an ops lead now owns the decision.",
  "admin.reports.duplicate_done": "Marked as a duplicate of the report you named.",
  "admin.reports.reply_removed": "The reply is off the public page. The text is kept for the record.",
  "admin.reports.error.gone": "That has already been decided.",
  "admin.reports.error.not_staff": "That person cannot work this queue.",
  "admin.reports.error.not_a_duplicate": "Those two are not the same work item.",
  "admin.reports.error.reply_gone": "There is no reply to remove, or it has already been removed.",
  "admin.reports.fix.not_yours": "An ops lead holds this one. Escalate the row and it will reach them.",
  "admin.reports.fix.not_found": "Go back to the queue and open it again — somebody may have decided it while this was open.",
  "admin.reports.fix.not_staff": "Pick a moderator or an ops lead from the list.",
  "admin.reports.fix.not_a_duplicate": "A duplicate points at another open report about the same business.",
  "admin.reports.fix.pick_outcome": "Pick one of the outcomes below.",

  /* ── Board 4h · deciding one ────────────────────────────────────────────── */
  "admin.reports.reason_hint": "What you decided and what you looked at. It goes in the audit log, and it is what the next person reads.",
  "admin.reports.also_closes": { one: "This closes {count} other report of the same thing.", other: "This closes {count} other reports of the same thing." },
  "admin.reports.escalate": "Escalate to an ops lead",
  "admin.reports.already_escalated": "Already escalated",
  "admin.reports.remove_reply": "Remove the seller's reply",
  "admin.reports.escalate_note": "Escalating leaves the report open and takes your name off it. Suspending the account and closing the listing are ops-lead decisions taken on the account.",
  "admin.reports.duplicate_of": "The report this duplicates",
  "admin.reports.mark_duplicate": "Mark as a duplicate",

  /* ── Board 4h · one report (B5) ─────────────────────────────────────────── */
  "admin.report_detail.title": "Report about {supplier}",
  "admin.report_detail.back": "Back to the queue",
  "admin.report_detail.resolved": "Decided: {outcome}",
  "admin.report_detail.what": "What was reported",
  "admin.report_detail.filed": "Filed",
  "admin.report_detail.reporter": "Reported by",
  "admin.report_detail.field": "Field",
  "admin.report_detail.owner": "Owner",
  "admin.report_detail.enquiry": "Enquiry",
  "admin.report_detail.outcome_reason": "Reason given",
  "admin.report_detail.decided_by": "Decided by",
  "admin.report_detail.escalation_reason": "Escalated because",
  "admin.report_detail.group": "The rest of this work item",
  "admin.report_detail.group_note": "{count} reports make up this work item. Deciding it decides all of them.",
  "admin.report_detail.review": "The review",
  "admin.report_detail.review_by": "{buyer} · {date}",
  "admin.report_detail.review_removed": "Removed",
  "admin.report_detail.review_held": "Held",
  "admin.report_detail.seller_reply": "{supplier} replied",
  "admin.report_detail.reply_removed_line": "This reply was removed by our team. The text is kept for the record.",
  "admin.report_detail.rail_label": "Decision, history and where the other decisions live",
  "admin.report_detail.decide": "Decide",
  "admin.report_detail.decide_note": "Three outcomes, a written reason on every one, and an audit row.",
  "admin.report_detail.already_decided": "Decided as {outcome} on {when}.",
  "admin.report_detail.history": "What else is on record",
  "admin.report_detail.history_note": "Counted across this supplier, open and decided.",
  "admin.report_detail.priors_field": "Reports of this field",
  "admin.report_detail.priors_business": "Decided reports about this supplier",
  "admin.report_detail.closed_with_it": "Closed as duplicates of this",
  "admin.report_detail.audit_link": "Read this in the audit log",
  "admin.report_detail.elsewhere": "Where the other decisions live",
  "admin.report_detail.elsewhere_note": "Suspending an account and closing a listing are ops-lead decisions with their own reasons and their own appeal path.",
  "admin.report_detail.open_account": "Open {supplier} in accounts",
  "admin.report_detail.open_listing": "Open the public listing",
  /* Board 13c — what the report modal now captures, on the detail screen. */
  "admin.report_detail.value_on_record": "On the listing when reported",
  "admin.report_detail.suggested_value": "Reporter says it should be",
  "admin.report_detail.suggested_category": "Reporter suggests the trade",
  "admin.report_detail.reference": "Reference",
  "admin.report_detail.reply_to": "Reply goes to",
  "admin.report_detail.reply_to.account": "Their account",
  "admin.report_detail.reply_to.email": "An email they left, used once",
  "admin.report_detail.reply_to.emailed": "An email they left, written to on {date} and then erased",
  "admin.report_detail.reply_to.none": "Nobody. They left no way to reach them",
  "admin.report_detail.value_group": "Same value on other listings",
  "admin.report_detail.value_group_note": "Open reports about this value on {listings} listings, from {sources} separate sources. Deciding this one closes none of the others.",
  "admin.report_detail.closing_already": "This listing is already under a closure notice.",
  "admin.report_detail.duplicate": "Same thing, reported twice",
  "admin.report_detail.duplicate_note": "For two reports the queue could not group — a photograph reported once as content and once as wrong details.",

  /* ── Board 4h · one review dispute ──────────────────────────────────────── */
  "admin.dispute_detail.title": "Review dispute from {supplier}",
  "admin.dispute_detail.resolved": "Decided: {outcome}",
  "admin.dispute_detail.case": "What the supplier says",
  "admin.dispute_detail.raised": "Raised",
  "admin.dispute_detail.raised_by": "Raised by",
  "admin.dispute_detail.review": "The review",
  "admin.dispute_detail.incentive": "We have a finding on this review",
  "admin.dispute_detail.incentive_when": "Logged {date}.",
  "admin.dispute_detail.decide_note": "Two outcomes. A review comes down or it stands; it cannot be corrected.",
  "admin.dispute_detail.already_decided": "Decided as {outcome} on {when}.",
  "admin.dispute_detail.open_reviews": "Open the public reviews page",

  /* ── Board 4h · detection thresholds (B11) ──────────────────────────────── */
  "admin.detectors.title": "Detection thresholds",
  "admin.detectors.rail_label": "What the sweeps have found",
  "admin.detectors.rules": "What the sweeps look for",
  "admin.detectors.rules_note": "These run overnight. Moving a line changes what lands in front of every moderator tomorrow, so the change is audited with a reason.",
  "admin.detectors.shared_phone": "One number on several listings",
  "admin.detectors.shared_phone_hint": "Counted across businesses, never across a firm's own branches.",
  "admin.detectors.shared_phone_field": "Report at this many listings",
  "admin.detectors.licence": "A licence long past expiry",
  "admin.detectors.licence_hint": "A listing still published and still taking enquiries, months after its trade licence lapsed.",
  "admin.detectors.licence_field": "Report after this many days",
  "admin.detectors.bounds": "Between {min} and {max}.",
  "admin.detectors.reason_hint": "What moved and why. It goes in the audit log.",
  "admin.detectors.save": "Save the thresholds",
  "admin.detectors.saved": "Saved. Tonight's sweep uses these.",
  "admin.detectors.error.sharedPhoneListings": "The listing count has to be a whole number between {min} and {max}.",
  "admin.detectors.error.licenceExpiredDays": "The expiry window has to be a whole number of days between {min} and {max}.",
  "admin.detectors.fix.bounds": "Put a number inside the range shown under the field.",
  "admin.detectors.filed": "What they have found",
  "admin.detectors.filed_note": "Every report each detector has filed, and how many a moderator closed as no action — which is what a threshold set too low looks like.",
  "admin.detectors.filed_caption": "Reports filed by each detector, and how many ended with no action",
  "admin.detectors.col_detector": "Detector",
  "admin.detectors.col_filed": "Filed",
  "admin.detectors.col_no_action": "No action",
  "admin.detectors.false_positive_note": "Off-platform payment detection has no threshold and no switch. It runs when a message is written, and a control that turns off fraud detection is one nobody notices is off.",
  "admin.detectors.cooling": "How often one can come back",
  "admin.detectors.cooling_note": "A detector says nothing more about a business while its own finding is open, and nothing for {days} days after one is closed.",
  ...
  // ── Standing item 9.5 — scheduled jobs ──
  // The record of the two cron routes. A run that did not happen is always said
  // in words ("missed", "missing"), never shown as a run that did nothing.
  "admin.jobs.title": "Scheduled jobs",
  "admin.jobs.eyebrow": "Platform",
  "admin.jobs.meta": "Recording since {date} · kept {days} days",
  "admin.jobs.meta_none": "Nothing recorded yet · kept {days} days",
  "admin.jobs.crons.title": "Crons",
  "admin.jobs.crons.caption": "Each cron's schedule, its last run, what that run did, and whether a scheduled run is missing",
  "admin.jobs.crons.col.cron": "Cron",
  "admin.jobs.crons.col.schedule": "Schedule",
  "admin.jobs.crons.col.last": "Last run",
  "admin.jobs.crons.col.outcome": "What it did",
  "admin.jobs.crons.col.next": "Next due",
  "admin.jobs.crons.col.state": "On time",
  "admin.jobs.crons.note": "A scheduled run counts as missed once {grace} minutes pass after its time with no run started. A run somebody starts by hand counts for the slot it falls in. Times are Dubai; the expressions are UTC, as Vercel reads them.",
  "admin.jobs.cron.daily": "Daily job",
  "admin.jobs.cron.sweep": "Hourly sweep",
  "admin.jobs.cron_lower.daily": "daily job",
  "admin.jobs.cron_lower.sweep": "hourly sweep",
  "admin.jobs.schedule.daily": "Every day at {time}",
  "admin.jobs.schedule.sweep": "Every hour at :{minute}",
  "admin.jobs.expression": "{expression} UTC",
  "admin.jobs.last.none": "No run recorded",
  "admin.jobs.run_state.ok": "Succeeded",
  "admin.jobs.run_state.failed": "Failed",
  "admin.jobs.run_state.running": "Running",
  "admin.jobs.run_state.unfinished": "No finish recorded",
  "admin.jobs.outcome.ok": { one: "{ok} of {planned} step returned", other: "{ok} of {planned} steps returned" },
  "admin.jobs.outcome.failed": { one: "{failed} of {planned} step threw", other: "{failed} of {planned} steps threw" },
  "admin.jobs.outcome.running": { one: "{recorded} of {planned} step so far", other: "{recorded} of {planned} steps so far" },
  "admin.jobs.outcome.unfinished": { one: "{recorded} of {planned} step recorded before it stopped", other: "{recorded} of {planned} steps recorded before it stopped" },
  "admin.jobs.outcome.unrecorded": { one: "{formatted} step's outcome did not reach the record", other: "{formatted} steps' outcomes did not reach the record" },
  "admin.jobs.outcome.took": "Took {duration}",
  "admin.jobs.took.running": "Still running",
  "admin.jobs.took.none": "No finish",
  "admin.jobs.timeliness.on_schedule": "On schedule",
  "admin.jobs.timeliness.late": "Late",
  "admin.jobs.timeliness.never": "Never ran",
  "admin.jobs.timeliness.waiting": "Not due yet",
  "admin.jobs.timeliness.no_record": "Nothing recorded",
  "admin.jobs.missed": { one: "{formatted} scheduled run missed, at {first}", other: "{formatted} scheduled runs missed, the first at {first}" },
  "admin.jobs.never_since": "No run since recording began, {date}",
  "admin.jobs.no_record_note": "No cron has written a row yet, so no run can be called missing.",
  "admin.jobs.refusal.no_secret": "CRON_SECRET is not set in this deployment, so every call is refused",
  "admin.jobs.refusal.wrong_secret": "The scheduler sent a secret that does not match CRON_SECRET",
  "admin.jobs.refused_at": "Refused {date}: {reason}",
  "admin.jobs.tabs": "Which cron the tables below are about",
  "admin.jobs.history.title": "Runs of the {cron}",
  "admin.jobs.history.caption": "Runs of the {cron}, newest first, with each scheduled run that did not happen",
  "admin.jobs.history.col.started": "Started",
  "admin.jobs.history.col.called_by": "Called by",
  "admin.jobs.history.col.took": "Took",
  "admin.jobs.history.col.steps": "Steps",
  "admin.jobs.history.col.state": "Outcome",
  "admin.jobs.called_by.scheduler": "Scheduler",
  "admin.jobs.called_by.hand": "By hand",
  "admin.jobs.history.threw": "Threw:",
  "admin.jobs.history.missing": "Missed",
  "admin.jobs.history.missed": { one: "The scheduled run did not start.", other: "{formatted} scheduled runs did not start, from {first} to {last}." },
  "admin.jobs.history.showing": { one: "{shown} of {formatted} run", other: "{shown} of {formatted} runs" },
  "admin.jobs.history.newest": "Newest runs",
  "admin.jobs.history.older": "Older runs",
  "admin.jobs.history.empty.title": "No run of the {cron} is recorded",
  "admin.jobs.history.empty.body": "The first call after the record went live writes its first row. The next run is due {next}.",
  "admin.jobs.failures.title": "Steps of the {cron} that threw in {days} days",
  "admin.jobs.failures.caption": "Each step of the {cron} that threw in the last {days} days, how many times, and what it said last",
  "admin.jobs.failures.col.step": "Step",
  "admin.jobs.failures.col.count": "Times",
  "admin.jobs.failures.col.last": "Last threw",
  "admin.jobs.failures.col.error": "What it said last",
  "admin.jobs.failures.empty": "No step of the {cron} threw in {days} days.",
  "admin.jobs.refusals.title": "Calls to the {cron} refused in {days} days",
  "admin.jobs.refusals.caption": "Calls to the {cron} that were turned away, newest first",
  "admin.jobs.refusals.col.when": "When",
  "admin.jobs.refusals.col.why": "Why",
  "admin.jobs.refusals.empty": "No call to the {cron} was refused in {days} days.",
  "admin.jobs.refusals.showing": { one: "The latest {shown} of {formatted} refused call", other: "The latest {shown} of {formatted} refused calls" },
  "admin.jobs.refusals.note": "Kept at most once an hour for each cron: every call while CRON_SECRET is unset, and a wrong secret sent under the scheduler's name. A caller guessing at the address is not recorded.",
  "admin.jobs.run.title": "{cron} · {date}",
  "admin.jobs.run.eyebrow": "Scheduled jobs",
  "admin.jobs.run.back": "All runs of the {cron}",
  "admin.jobs.run.facts_title": "The run",
  "admin.jobs.run.outcome": "Outcome",
  "admin.jobs.run.steps": "Steps",
  "admin.jobs.run.started": "Started",
  "admin.jobs.run.finished": "Finished",
  "admin.jobs.run.took": "Took",
  "admin.jobs.run.called_by": "Called by",
  "admin.jobs.run.scheduler_with": "Scheduler, {expression} UTC",
  "admin.jobs.run.no_finish": "No finish recorded",
  "admin.jobs.run.not_recorded": "Not recorded",
  "admin.jobs.run.refused_title": "{cron} · refused {date}",
  "admin.jobs.run.refused_body": "Refused: {reason}. No step ran.",
  "admin.jobs.run.error_note": "A step's message is stored with addresses and secrets masked. The stack is in the function log at the same time.",
  "admin.jobs.steps.title": "Steps",
  "admin.jobs.steps.caption": "Each step the run set out to take, in order, with what it returned or what it threw",
  "admin.jobs.steps.col.position": "#",
  "admin.jobs.steps.col.step": "Step",
  "admin.jobs.steps.col.outcome": "Outcome",
  "admin.jobs.steps.col.took": "Took",
  "admin.jobs.steps.col.detail": "Returned or threw",
  "admin.jobs.step_state.ok": "Returned",
  "admin.jobs.step_state.failed": "Threw",
  "admin.jobs.step_state.in_progress": "Running",
  "admin.jobs.step_state.no_finish": "No finish recorded",
  "admin.jobs.step_state.not_reached": "Not reached",
  "admin.jobs.step_state.not_recorded": "Not recorded",
  "admin.jobs.step_note.in_progress": "The run is on this step now.",
  "admin.jobs.step_note.no_finish": "The step before this one finished and wrote its row, so this one began. Nothing after it was recorded.",
  "admin.jobs.step_note.not_reached": "Nothing is recorded for this step.",
  "admin.jobs.step_note.not_recorded": "The run finished, and this step's row did not reach the database. The function log has what it did.",
  "admin.jobs.result.none": "Returned nothing",
  "admin.jobs.result.items": { one: "{formatted} item", other: "{formatted} items" },
  "admin.jobs.result.fields": { one: "{formatted} field", other: "{formatted} fields" },
  "admin.jobs.result.summarised": "Summarised: the result was too long to keep as it came, so each list shows its length.",
  "admin.jobs.result.raw": "As recorded",
  ...
  "audit.action.report_assigned": "set the owner of a report",
  "audit.action.report_escalated": "escalated a report to an ops lead",
  "audit.action.report_detectors_tuned": "moved a report-detection threshold",
  ...
  "admin.staff.matrix_group.staff": "Staff, audit & scheduled jobs",
  ...
  "staff.capability.report.detectors": "Move a report-detection threshold",
  ...
  "staff.capability.revenue.read": "Read and export finance data",
  ...
  "staff.capability.jobs.read": "Read the scheduled-job record",
  "nav.locked": "locked",
  "nav.later": "soon",
  ...
  /* Board 13c. The promise is kept: every report is written with the licence record's answer (B3). */
  "report_listing.lede": "Tell us what is wrong with this listing. We check every report against the licence record.",
  "report_listing.loading": "Opening the report form",
  "report_listing.kind_legend": "What is wrong",
  "report_listing.kind.closed": "Permanently closed",
  "report_listing.kind_hint.closed": "The unit is empty, or they have moved and the address still points here.",
  "report_listing.kind.wrong_details": "A detail is wrong",
  "report_listing.kind_hint.wrong_details": "The number rings a different company, the address is not theirs, the name is wrong.",
  "report_listing.kind.wrong_trade": "Not this trade",
  "report_listing.kind_hint.wrong_trade": "They do not do this work, or the description is of a different business.",
  "report_listing.kind.content": "A photograph or a description is not theirs",
  "report_listing.kind_hint.content": "Somebody else's photograph, a watermark from another supplier, copied text.",
  /* Board 13c B10. Not a report: the row leads to the claim flow, which takes a trade licence. */
  "report_listing.kind.claim_dispute": "Someone else claimed my business",
  "report_listing.kind_hint.claim_dispute": "This is your company and another account holds the listing. That is decided on your trade licence, not on a report.",
  "report_listing.kind_hint.claim_dispute_unclaimed": "Nobody holds this listing yet. If it is your company, claim it with your trade licence.",
  "report_listing.field_legend": "Which detail",
  "report_listing.field.phone": "Telephone number",
  "report_listing.field.address": "Address",
  "report_listing.field.website": "Website",
  "report_listing.field.name": "Company name",
  "report_listing.field.category": "Trade or category",
  "report_listing.field.photo": "A photograph",
  "report_listing.field.description": "The description",
  "report_listing.field.hours": "Opening hours",
  "report_listing.field.licence": "Trade licence",
  "report_listing.correction_label": "What should the {field} say",
  "report_listing.correction_hint.phone": "The number that reaches this business, if you have it. We check it against the licence record before anything changes.",
  "report_listing.correction_hint.address": "The address they trade from now, if you know it.",
  "report_listing.correction_hint.name": "The name on their sign or their trade licence.",
  "report_listing.correction_hint.website": "The address of their own website.",
  "report_listing.correction_hint.hours": "The hours you found them open, for example Sat to Thu 08:00 to 18:00.",
  "report_listing.category_label": "Which trade should it be",
  "report_listing.category_hint": "From the same list suppliers are filed under. Leave it if you are not sure.",
  "report_listing.category_placeholder": "Choose a trade",
  "report_listing.category_general": "{sector}, general",
  "report_listing.detail_label": "Anything that helps us check",
  "report_listing.detail_hint": "What you tried and what happened. A moderator reads it next to the licence record.",
  "report_listing.email_label": "Your email",
  "report_listing.email_hint": "We write once, when a moderator has decided, and then delete it. The business never sees it.",
  "report_listing.reply_account": "You are signed in, so the outcome comes to your account.",
  /* Board 13c correction 1: the threshold the queue actually computes — one value, not one field name. */
  "report_listing.threshold_note": "Three people reporting the same detail flag the listing for a moderator.",
  "report_listing.submit": "Send report",
  "report_listing.claim.title": "A claim, not a report",
  "report_listing.claim.needs_licence": "You upload the trade licence the business holds.",
  "report_listing.claim.needs_name": "You give your name and your role in the company.",
  "report_listing.claim.decided_by": "If another account holds the listing, an ops lead decides between the two on the licence record.",
  "report_listing.claim.cta": "Claim this listing",
  "report_listing.filed.title": "Report sent about {business}",
  "report_listing.filed.reference_label": "Your reference",
  "report_listing.filed.next_title": "What happens next",
  "report_listing.filed.next_check": "A moderator checks it against the licence record within {days} days.",
  "report_listing.filed.reply_account": "The outcome comes to your account, whichever way it goes.",
  "report_listing.filed.reply_email": "We email {email} once, when it is decided, and then delete the address.",
  "report_listing.filed.reply_none": "You did not leave an email, so we have nowhere to send the outcome. Keep {reference} to look it up.",
  "report_listing.filed.next_listing": "Nothing on the listing changes until a moderator decides. The business is never told who reported it.",
  "report_listing.filed.status_prefix": "Look up this report at any time:",
  "report_listing.filed.status_link": "report status",
  "report_listing.filed.back": "Back to the listing",
  "report_listing.not_a_payment_desk": "This is not a payment desk. Buyers pay suppliers directly on terms the two of them agree, and we hold no money — if a payment has gone wrong, that is between you and the supplier.",
  "report_listing.error.not_found": "That listing is not one we can take a report about.",
  "report_listing.fix.not_found": "Go back to the listing and try again from the link on the page.",
  "report_listing.error.invalid_kind": "Choose what is wrong.",
  "report_listing.fix.invalid_kind": "Pick one of the reasons above.",
  "report_listing.error.invalid_field": "Choose which detail is wrong.",
  "report_listing.fix.invalid_field": "Pick one of the details under the reason. The list only holds what this listing shows.",
  "report_listing.error.too_long": "That is longer than the box holds.",
  "report_listing.fix.too_long": "Keep it to the part a moderator has to check.",
  "report_listing.error.correction_too_long": "That is longer than a correction needs to be.",
  "report_listing.fix.correction_too_long": "Write the value as it should read, and put anything else in the box below.",
  "report_listing.error.invalid_category": "That trade cannot be suggested for this listing.",
  "report_listing.fix.invalid_category": "Choose a different trade from the list, or leave it empty.",
  "report_listing.error.invalid_email": "That email address is missing part of it.",
  "report_listing.fix.invalid_email": "Use the full address, for example name@example.ae, or leave it empty.",
  "report_listing.error.already_reported": "This has already been reported from here, and that report is still open.",
  "report_listing.fix.already_reported": "We will not count it twice. If a different detail is wrong, choose that one instead.",
  "report_listing.error.rate_limited": "That is more reports than we take from one place in an hour.",
  "report_listing.fix.rate_limited": "Try again a little later, or sign in so the limit counts you rather than your network.",
  "report_listing.error.listing_rate_limited": "This listing has had more reports in the last hour than we take.",
  "report_listing.fix.listing_rate_limited": "The ones already in are with a moderator. Try again in an hour if yours is about something else.",

  /* ── Board 13c · /report, the hub the footer opens, and the reference lookup ── */
  "report_hub.meta_title": "Report a listing",
  "report_hub.title": "Report a listing",
  "report_hub.lede": "Every listing carries its own report form, so a report names the business it is about and cannot land on the wrong one. Find the listing, then use Report this listing on its page.",
  "report_hub.find_title": "Find the listing",
  "report_hub.find_body": "Search by the company's name, trade or area.",
  "report_hub.find_label": "Company, trade or area",
  "report_hub.find_submit": "Search",
  "report_hub.lookup_title": "Look up a report you sent",
  "report_hub.lookup_body": "The reference was on the confirmation after you sent it. It works whether or not you left an email.",
  "report_hub.lookup_label": "Reference",
  "report_hub.lookup_hint": "RP- and eight letters and digits, for example RP-4K2M9XQT.",
  "report_hub.lookup_submit": "Look up",
  "report_hub.malformed": "That is not the shape of a report reference.",
  "report_hub.malformed_fix": "Copy it from the confirmation. It starts RP- and has eight letters and digits after it.",
  "report_hub.unknown": "No report has the reference {reference}.",
  "report_hub.unknown_fix": "Check it against the confirmation letter by letter. The letters I, L, O and U are never used, so 0 and 1 are digits.",
  "report_hub.limited": "That is more look-ups than we answer from one place in a minute.",
  "report_hub.limited_fix": "Wait a minute and try again.",
  "report_hub.state_open": "With a moderator",
  "report_hub.state_decided": "Decided",
  "report_hub.listing": "Listing",
  "report_hub.reason": "What you reported",
  "report_hub.filed": "Sent",
  "report_hub.outcome": "Outcome",
  "report_hub.outcome_open": "Not decided yet. A moderator decides within {days} days of it being sent.",
  "report_hub.outcome.seller_corrected": "The business corrected the listing, {date}.",
  "report_hub.outcome.upheld": "We agreed and changed the listing, {date}.",
  "report_hub.outcome.no_action": "We checked it against the record and found nothing to change, {date}.",
  "report_hub.kind.closed": "Permanently closed",
  "report_hub.kind.wrong_details": "A detail is wrong",
  "report_hub.kind.wrong_trade": "Not this trade",
  "report_hub.kind.content": "A photograph or a description is not theirs",
  "report_hub.kind.claim_conflict": "Two companies on one listing",
  "report_hub.kind.off_platform_payment": "Asked to pay outside the record",
  "report_hub.kind.review_integrity": "A review's integrity",
  ...
  */
  ...
  "verify.read_policy": "How we check a licence",
  ...
  */
  ...
  "rfq.deliver_to_hint": "Your company's saved addresses. Suppliers see the area and access hours; the address itself only reaches the one you accept.",
  "rfq.deliver_to_elsewhere": "Somewhere else",
  "rfq.emirate": "Emirate",
  ...
  */
  ...
  // ── Buyer: comparing the quotes received [1n] ──
  "compare_quotes.lines": { one: "{count} line", other: "{count} lines" },
  "compare_quotes.sent_to": { one: "sent to {count} supplier", other: "sent to {count} suppliers" },
  "compare_quotes.received": { one: "{count} quote received", other: "{count} quotes received" },
  "compare_quotes.received_none": "no quotes yet",
  "compare_quotes.export": "Export comparison",
  ...
  "compare_quotes.eyebrow_closes_in": "Closes in {when}",
  "compare_quotes.eyebrow_closes_on": "Closes {date}",
  "compare_quotes.table_label": "Quotes, line by line",
  "compare_quotes.caption": { one: "The quote from {count} supplier, priced line by line, excluding VAT", other: "Quotes from {count} suppliers, priced line by line, excluding VAT" },
  "compare_quotes.col.supplier": "Supplier",
  ...
  "compare_quotes.sort.received": "As received",
  "compare_quotes.sort.total": "Total, complete quotes first",
  "compare_quotes.sort.lead": "Lead time",
  "compare_quotes.rating": { one: "{rating} from {count} review", other: "{rating} from {count} reviews" },
  "compare_quotes.quoted_in": "Quoted in {duration}",
  "compare_quotes.superseded": "Priced against R{revision} — your requirement has changed since",
  "compare_quotes.total.partial": "{quoted} of {total} lines",
  "compare_quotes.total.extra": { one: "Includes {amount} on {count} line not on your request", other: "Includes {amount} on {count} lines not on your request" },
  "compare_quotes.not_quoted": "Not quoted",
  "compare_quotes.cell.parts": { one: "in {count} part", other: "in {count} parts" },
  "compare_quotes.cell.each": "{price} each",
  "compare_quotes.cell.lowest": "Lowest for this line",
  "compare_quotes.cell.no_qty": "Priced as a lot, not per unit — you asked for {asked}",
  "compare_quotes.cell.other_qty": "For {qty}, not the {asked} you asked for",
  "compare_quotes.lead.not_stated": "Not stated",
  "compare_quotes.lead.ex_stock": "Ex-stock",
  "compare_quotes.lead.days": { one: "{count} day", other: "{count} days" },
  "compare_quotes.lead.in_time": "In time for {date}",
  "compare_quotes.lead.late": "After your {date}",
  "compare_quotes.view": "View",
  "compare_quotes.view_named": "View {supplier}'s quote in your thread with them",
  "compare_quotes.state.accepted": "Accepted",
  "compare_quotes.state.declined": "Declined",
  "compare_quotes.state.expired": "Expired {date}",
  "compare_quotes.state.supplier_closed": "Supplier closed their account",
  "compare_quotes.state.closed": "Enquiry closed",
  "compare_quotes.accept": "Accept",
  "compare_quotes.accept_named": "Accept {supplier}'s quote {ref}, {total}",
  "compare_quotes.approval_named": "Send {supplier}'s quote {ref}, {total}, for approval",
  "compare_quotes.approval_by": "Goes to {names} first",
  "compare_quotes.approval_nobody": "Nobody on your team can approve it under the current rule",
  "compare_quotes.sheet.terms": "Terms quoted: {payment}. Delivery: {delivery}.",
  "compare_quotes.sheet.held": "The prices are held until {date}.",
  "compare_quotes.sheet.cancel": "Keep comparing",
  "compare_quotes.nudge": "Nudge",
  "compare_quotes.nudge_sent": "Nudged",
  "compare_quotes.nudged": "Nudged {when}",
  "compare_quotes.waiting.replied": "Wrote in your thread {when} — no quote yet",
  "compare_quotes.waiting.opened": "Opened the request {when} — no quote yet",
  "compare_quotes.waiting.delivered": "Sent {when} — not opened yet",
  "compare_quotes.no_quote.declined_reason": "Declined to quote: {reason}",
  "compare_quotes.no_quote.declined": "Declined to quote",
  "compare_quotes.no_quote.none": "Did not quote",
  "compare_quotes.none_title": "No quotes yet",
  "compare_quotes.none_body": { one: "Your enquiry reached {count} supplier. Quotes appear here line by line as they arrive, and a supplier who has not answered can be nudged once, a day after it reached them.", other: "Your enquiry reached {count} suppliers. Quotes appear here line by line as they arrive, and a supplier who has not answered can be nudged once, a day after it reached them." },
  "compare_quotes.none_body_closed": { one: "This enquiry closed without a quote from the {count} supplier it reached. Re-send it from your enquiries to ask again.", other: "This enquiry closed without a quote from any of the {count} suppliers it reached. Re-send it from your enquiries to ask again." },
  "compare_quotes.cheapest.eyebrow": "Cheapest per line",
  "compare_quotes.cheapest.deliveries": { one: "{count} delivery", other: "{count} deliveries" },
  "compare_quotes.cheapest.body": "Splitting across {suppliers} would land at {total} — {saving} under the best single quote, across {deliveries}.",
  "compare_quotes.cheapest.body_no_single": "Taking each line from its lowest quote, across {suppliers}, would land at {total} across {deliveries}. No single supplier quoted every line.",
  "compare_quotes.cheapest.one_supplier": "You accept one supplier per enquiry, so this is a figure to negotiate with rather than one to accept. A supplier can send a revised quote in your thread with them.",
  "compare_quotes.cheapest.thread": "Your thread with {supplier}",
  "compare_quotes.on_accept.eyebrow": "What happens on accept",
  "compare_quotes.on_accept.accepted": "The quote is accepted at its prices.",
  "compare_quotes.on_accept.declined": { one: "The other supplier is told you chose another quote.", other: "The other {count} suppliers are told you chose another quote, so none of them is left waiting." },
  "compare_quotes.on_accept.no_payment": "We take no payment and hold no funds: the supplier invoices you directly, on terms the two of you agree.",
  "compare_quotes.on_accept.approval": "On a row that reads Send for approval, the quote goes to {names} first, and nothing is released or declined until it is approved.",
  "compare_quotes.on_accept.approval_nobody": "On a row that reads Send for approval, nobody on your team can approve it under the current rule, and the accept screen says why.",
  "compare_quotes.on_accept.done": "The accepted supplier has your contact details, and the others were told you chose another quote. Payment and delivery are between you and the supplier.",
  "compare_quotes.message_all.button": "Message all",
  "compare_quotes.message_all.title": "Message every supplier",
  "compare_quotes.message_all.description": "One message, sent to each supplier in their own thread with you. None of them sees who else was asked.",
  "compare_quotes.message_all.label": "Your message",
  "compare_quotes.message_all.hint": "Up to {max} characters. Each supplier replies in their own thread.",
  "compare_quotes.message_all.recipients": { one: "Goes to {count} supplier: {names}.", other: "Goes to {count} suppliers: {names}." },
  "compare_quotes.message_all.send": { one: "Send to {count} supplier", other: "Send to {count} suppliers" },
  "compare_quotes.message_all.cancel": "Cancel",
  "compare_quotes.message_all.close": "Close",
  "compare_quotes.message_all.counter": "{used} / {limit}",
  "compare_quotes.message_all.sent": { one: "Sent to {count} supplier. The reply arrives in your thread with them.", other: "Sent to {count} suppliers. Each reply arrives in your thread with that supplier." },
  "compare_quotes.message_all.partial": "Sent to {sent} of {total} suppliers. {names} could not take it, because their thread closed while it was sending.",
  "compare_quotes.message_all.error.not_found": "This enquiry is not one of yours, or it no longer exists.",
  "compare_quotes.message_all.error.empty": "Write a message first. It is sent exactly as you type it.",
  "compare_quotes.message_all.error.too_long": "Keep it to {max} characters. A longer specification belongs in a file, attached in a thread.",
  "compare_quotes.message_all.error.decided": "This enquiry has an accepted quote, so the other suppliers' threads take no new messages.",
  "compare_quotes.message_all.error.closed": "This enquiry has closed, so its threads take no new messages. Re-send it from your enquiries to ask again.",
  "compare_quotes.message_all.error.nobody": "No supplier on this enquiry can take a message: each has declined it or closed their account.",
  "compare_quotes.message_all.error.rate_limited": "You messaged every supplier a moment ago. You can send another in {minutes} min.",
  "compare_quotes.csv.caveat": "Quotes on {ref}, as each supplier sent them to you. All amounts in AED, excluding VAT.",
  "compare_quotes.csv.supplier": "Supplier",
  "compare_quotes.csv.quote": "Quote",
  "compare_quotes.csv.status": "Status",
  "compare_quotes.csv.verification": "Verification",
  "compare_quotes.csv.line": "{line}{qty} (AED)",
  "compare_quotes.csv.lines_quoted": "Lines quoted",
  "compare_quotes.csv.lead_days": "Lead time, days (slowest line)",
  "compare_quotes.csv.total": "Total excl. VAT (AED)",
  "compare_quotes.csv.payment": "Payment terms",
  "compare_quotes.csv.delivery": "Delivery",
  "compare_quotes.csv.valid_until": "Valid until",
  "compare_quotes.csv.lowest": "Lowest per line",
  "compare_quotes.csv.state.open": "Open to accept",
  "compare_quotes.csv.state.accepted": "Accepted",
  "compare_quotes.csv.state.declined": "Declined",
  "compare_quotes.csv.state.expired": "Expired",
  "compare_quotes.csv.state.supplier_closed": "Supplier closed their account",
  "compare_quotes.csv.state.closed": "Enquiry closed",
  "compare_quotes.csv.state.replied": "Wrote in the thread, no quote yet",
  "compare_quotes.csv.state.opened": "Opened, no quote yet",
  "compare_quotes.csv.state.delivered": "Not opened yet",

  // ── What accepting releases, named — boards 1n B9, 10h, 7b ──
  "release.person": "Your name, mobile and email go to that supplier only.",
  "release.person_named": "Your name, mobile and email go to {supplier}, and to nobody else.",
  "release.company": "So do {company}'s registered name, TRN, trade licence number and accounts email, for their tax invoice.",
  "release.address": "So does the delivery address, with the person to ask for there.",
  ...
  "accepted.report.outcome.duplicate": "the same thing, already decided",
  ...
  "account.tab.company": "Company & team",

  // Board 7b — the buying company's account, /account/company.
  "company.title": "Company & team",
  "company.title_named": "{company} — company & team",
  "company.rail_label": "Approval rule and requests",
  "company.created": "Your company is set up. You are its admin.",
  "company.joined": "You have joined {company}. Quotes you accept on enquiries you send for it follow its approval rule.",
  "company.dialog.cancel": "Cancel",
  "company.dialog.close": "Close",

  "company.create.title": "Set up your company",
  "company.create.lede": "Enquiries stay yours. A company adds what a procurement team needs around them: the details a supplier puts on your tax invoice, where deliveries go, who can accept a quote, and one rule for when someone else must agree.",
  "company.create.invited": "{company} has invited you to join them. Open the link in the invitation email to accept it before {date}.",
  "company.create.why_details_title": "Details for the tax invoice",
  "company.create.why_details": "Your registered name, TRN, licence number and accounts email go to the supplier whose quote you accept.",
  "company.create.why_addresses_title": "Addresses with access hours",
  "company.create.why_addresses": "Loading bay hours and load limits travel with your enquiries, so quotes are priced for the site.",
  "company.create.why_team_title": "A team with spend limits",
  "company.create.why_team": "Invite colleagues, give each a monthly limit, and set when a quote needs someone else's approval.",
  "company.create.submit": "Set up the company",

  "company.details.title": "Company details",
  "company.details.description": "The supplier whose quote you accept receives these with your contact details, to put on the tax invoice they issue you. A wrong TRN means you cannot reclaim the VAT.",
  "company.details.name": "Registered company name",
  "company.details.trn": "TRN",
  "company.details.trn_hint": "15 digits, as on your VAT certificate. We check the format; we do not check it against the FTA register.",
  "company.details.trn_invalid": "A TRN is 15 digits. Spaces and dashes are fine.",
  "company.details.licence": "Trade licence number",
  "company.details.licence_hint": "As printed on the licence, for example DED-772104.",
  "company.details.accounts_email": "Accounts email for invoices",
  "company.details.accounts_email_hint": "Where the supplier sends the tax invoice.",
  "company.details.save": "Save details",
  "company.details.saved": "Details saved. The change is in the company history.",
  "company.details.unchanged": "Nothing changed, so nothing was saved.",
  "company.details.changed": "Last changed by {name}, {date}",

  "company.field.required": "This is required.",
  "company.field.required_marker": "Required",
  "company.field.optional_marker": "Optional",
  "company.field.too_long": "Keep this to {max} characters.",
  "company.field.invalid": "This does not look right. Check it and try again.",
  "company.field.email_invalid": "Enter an email address, like accounts@example.ae.",

  "company.address.title": "Delivery addresses",
  "company.address.description": "The area and access constraints go out with every enquiry you send there. The address line and contact reach only the supplier whose quote you accept.",
  "company.address.add": "+ Add address",
  "company.address.add_title": "Add a delivery address",
  "company.address.edit_title": "Edit {label}",
  "company.address.dialog_description": "Access hours and the load limit are what a supplier plans the vehicle around.",
  "company.address.add_submit": "Add address",
  "company.address.save": "Save address",
  "company.address.added": "Address added.",
  "company.address.saved": "Address saved. Enquiries already sent keep the address they went with.",
  "company.address.archive": "Archive address",
  "company.address.archive_body": "It stops being offered on new enquiries. Enquiries already sent there keep it.",
  "company.address.archive_confirm": "Archive address",
  "company.address.archived": "Address archived.",
  "company.address.default": "Default",
  "company.address.default_legend": "Default delivery address",
  "company.address.default_set": "Default address changed. New enquiries preselect it.",
  "company.address.edit": "Edit",
  "company.address.edit_named": "Edit {label}",
  "company.address.row_title": "{label} — {place}",
  "company.address.place": "{area}, {emirate}",
  "company.address.attn": "Attn. {name}",
  "company.address.empty_title": "No delivery addresses yet",
  "company.address.empty_admin": "Add the first one. It becomes the default your enquiries preselect.",
  "company.address.empty_member": "An admin adds the company's addresses. Until then, enquiries name an area in their own words.",
  "company.address.label": "Name of the address",
  "company.address.label_hint": "What your team calls it, for example Marina Plaza, Tower 2, Level 14.",
  "company.address.line": "Address line",
  "company.address.line_hint": "Building, floor or unit, street.",
  "company.address.emirate": "Emirate",
  "company.address.emirate_placeholder": "Choose an emirate",
  "company.address.area": "Area",
  "company.address.area_hint": "Suppliers covering this area are matched to your enquiries.",
  "company.address.area_placeholder": "Choose an area",
  "company.address.area_needs_emirate": "Choose an emirate first",
  "company.address.attn_name": "Attn.",
  "company.address.attn_phone": "Attn. phone",
  "company.address.attn_phone_hint": "A UAE number, for example 050 220 1188.",
  "company.address.phone_invalid": "Enter a UAE number, like 050 220 1188 or +971 4 331 0000.",
  "company.address.access_point": "Access point",
  "company.address.access_point_hint": "Loading bay, reception, site store.",
  "company.address.access_from": "Access from",
  "company.address.access_until": "Access until",
  "company.address.time_invalid": "Enter a time as HH:MM, for example 07:00.",
  "company.address.window_order": "The access window has to end after it starts.",
  "company.address.load": "Load limit",
  "company.address.load_none": "No limit stated",
  "company.address.load.small_parcels": "Small parcels only",
  "company.address.load.pallets": "Pallets, no full loads",
  "company.address.load.full_loads": "Full truck loads accepted",
  "company.address.point_window": "{point} access {from}–{until}",
  "company.address.point_before": "{point} access before {until}",
  "company.address.point_after": "{point} access from {from}",
  "company.address.deliveries_window": "Deliveries {from}–{until}",
  "company.address.deliveries_before": "Deliveries before {until}",
  "company.address.deliveries_after": "Deliveries from {from}",

  "company.team.title": "Team & approvals",
  "company.team.description": "Who can raise a requirement, and who can commit money",
  "company.team.caption": "People in the company, their role, their spend authority and what they have used this month",
  "company.team.col.person": "Person",
  "company.team.col.role": "Role",
  "company.team.col.authority": "Can approve up to",
  "company.team.col.used": "Used this month",
  "company.team.col.status": "Status",
  "company.team.col.actions": "Actions",
  "company.team.you": "you",
  "company.team.approver": "Named approver",
  "company.team.active": "Active",
  "company.team.invited": "Invited",
  "company.team.expired": "Expired",
  "company.team.expires_on": "Expires {date}",
  "company.team.expired_on": "Expired {date}",
  "company.team.invite": "+ Invite",
  "company.team.invite_title": "Invite a colleague",
  "company.team.invite_description": "One person per seat. The table records who accepted and who approved each quote, so a shared login would hide who committed money.",
  "company.team.invite_submit": "Send invitation",
  "company.team.full_name": "Full name",
  "company.team.full_name_hint": "A person, not a job title.",
  "company.team.email": "Work email",
  "company.team.role": "Role",
  "company.team.limit": "Monthly limit",
  "company.team.limit_hint": "What they can accept in a calendar month without approval, counted in Dubai time.",
  "company.team.limit_required": "Procurement needs a monthly limit.",
  "company.team.limit_invalid": "Enter the limit in whole dirhams, for example 25000.",
  "company.team.link_emailed": "Invitation emailed to {email}. The link below works for 7 days if you would rather send it yourself.",
  "company.team.link_not_emailed": "The invitation email could not be sent. Copy the link and send it yourself; it works for 7 days.",
  "company.team.the_invitee": "them",
  "company.team.link_label": "Invitation link",
  "company.team.copy": "Copy link",
  "company.team.copied": "Copied",
  "company.team.resend": "Resend",
  "company.team.resend_named": "Resend the invitation to {email}",
  "company.team.revoke": "Revoke",
  "company.team.revoke_named": "Revoke the invitation to {email}",
  "company.team.invite_revoked": "Invitation revoked. The link no longer works.",
  "company.team.edit": "Edit",
  "company.team.edit_named": "Edit {name}'s seat",
  "company.team.edit_title": "{name}'s seat",
  "company.team.edit_description": "A new limit applies from the next quote. What they used this month stays counted.",
  "company.team.seat_save": "Save seat",
  "company.team.seat_saved": "Seat saved.",
  "company.team.deactivate": "Deactivate",
  "company.team.deactivate_named": "Deactivate {name}",
  "company.team.deactivate_title": "Deactivate {name}?",
  "company.team.deactivate_body": "{name} stops sending enquiries or accepting quotes for the company, and any request of theirs waiting for approval is withdrawn. Their enquiries and every approval they raised or gave stay on the record under their name.",
  "company.team.deactivate_confirm": "Deactivate",
  "company.team.deactivated": "Deactivated. Their history stays on the record.",
  "company.team.leave": "Leave",
  "company.team.leave_title": "Leave the company?",
  "company.team.leave_body": "You stop sending enquiries or accepting quotes for the company, and your requests waiting for approval are withdrawn. Your own enquiries stay yours.",
  "company.team.leave_confirm": "Leave the company",
  "company.team.left": "You have left the company.",
  "company.team.spend": { one: "{amount} accepted across the company this month, on {count} quote.", other: "{amount} accepted across the company this month, on {count} quotes." },
  "company.team.spend_none": "Nothing accepted across the company this month yet.",
  "company.team.spend_no_total": { one: "{count} more has no single total.", other: "{count} more have no single total." },
  "company.team.approvals_link": "Approvals and spend",

  "company.role.company_admin": "Admin",
  "company.role.procurement": "Procurement",
  "company.role.requester": "Requester",
  "company.role_hint.company_admin": "Edits the company, its team and its rule. No spend limit.",
  "company.role_hint.procurement": "Accepts quotes up to a monthly limit, and approves others' within it.",
  "company.role_hint.requester": "Sends enquiries. Every quote they want accepted goes for approval.",
  "company.authority.unlimited": "Unlimited",
  "company.authority.none": "Cannot approve",
  "company.authority.monthly": "{amount} a month",

  "company.rule.title": "Approval rule",
  "company.rule.description": "One rule, in plain words. This is the difference between a procurement team using the platform and going back to email.",
  "company.rule.an_admin": "an admin",
  "company.rule.threshold": "Quotes over {amount} need approval from {approver} before they are accepted.",
  "company.rule.no_threshold": "There is no company threshold. Each person accepts quotes within their own authority.",
  "company.rule.procurement": "Procurement accept quotes up to their own monthly limit. A quote beyond what is left goes to someone whose limit covers it.",
  "company.rule.requesters": "A quote a requester wants accepted goes for approval at any value.",
  "company.rule.unverified": "Quotes from suppliers without a verified trade licence need approval from {approver}, at any value.",
  "company.rule.no_total": "A quote with no single total, such as a fee per visit or per month, counts as over every limit.",
  "company.rule.po_and_cost_code": "A PO number and a cost code are required to accept a quote.",
  "company.rule.po": "A PO number is required to accept a quote.",
  "company.rule.cost_code": "A cost code is required to accept a quote.",
  "company.rule.not_own": "Nobody approves their own request.",
  "company.rule.gap": "Nobody can approve {approver}'s own quotes that this rule holds, because there is no second admin.",
  "company.rule.gap_fix": "Make another colleague an admin, or name a different approver.",
  "company.rule.threshold_label": "Approval threshold",
  "company.rule.threshold_hint": "Quotes above this need the approver. Leave it empty for no threshold.",
  "company.rule.approver_label": "Approver",
  "company.rule.approver_hint": "An admin. Nobody approves their own request, so another admin approves the approver's.",
  "company.rule.approver_any_admin": "Any admin",
  "company.rule.save": "Save rule",
  "company.rule.saved": "Rule saved. The sentences above now describe it.",
  "company.rule.admins_only": "Only an admin changes the rule.",

  "company.flag.po": "Require a PO number",
  "company.flag.po_hint": "Asked for when a quote is accepted, and printed on the accepted record.",
  "company.flag.cost_code": "Require a cost code",
  "company.flag.cost_code_hint": "Asked for when a quote is accepted, and printed on the accepted record.",
  "company.flag.unverified": "Unverified suppliers need approval",
  "company.flag.unverified_hint": "Applies when a quote is accepted. Search results and who receives your enquiries are unchanged.",
  "company.flag.off_platform": "Tell admins when a supplier asks to be paid off-platform",
  "company.flag.off_platform_hint": "Our message scanner flags bank details and requests to pay outside Business Listings. Nothing is blocked; admins are told by email.",

  "company.reason.over_threshold": "Over the {amount} threshold",
  "company.reason.over_threshold_removed": "Over the company threshold when it was raised",
  "company.reason.over_limit": "Beyond {name}'s monthly limit: {used} of {limit} already used",
  "company.reason.over_limit_plain": "Beyond {name}'s monthly limit",
  "company.reason.no_authority": "{name} is a requester and cannot commit money",
  "company.reason.unverified_supplier": "The supplier's trade licence is not verified",
  "company.reason.no_total": "No single total to hold against a limit",

  "company.approval.no_total": "no single total",
  "company.amount_ex_vat": "{amount} excl. VAT",
  "company.approval.a_colleague": "A colleague",
  "company.approval.next_approved": "The quote is accepted and the supplier has your contact details.",
  "company.approval.next_queried": "Answer the question to send it back for approval.",
  "company.approval.approved": "Approved. The quote is accepted and the supplier has been told.",
  "company.approval.queried": "Sent back with your question.",
  "company.approval.answered": "Answered. It is waiting for approval again.",
  "company.approval.withdrawn": "Request withdrawn.",

  "company.awaiting.eyebrow": "Awaiting your approval",
  "company.awaiting.none": "Nothing is waiting for your approval.",
  "company.awaiting.all": "All approvals and spend",
  "company.awaiting.more": { one: "{count} more waiting — see all approvals", other: "{count} more waiting — see all approvals" },
  "company.yours.eyebrow": "Your requests",
  "company.flagged.eyebrow": "Flagged in your threads",
  "company.flagged.description": "Messages our scanner flagged in the last 90 days. Our review team has each one.",

  "company.request.summary": { one: "{supplier} — {count} line, {amount}", other: "{supplier} — {count} lines, {amount}" },
  "company.request.summary_proposal": "{supplier} — {amount}",
  "company.request.raised_by": "Raised by {name}",
  "company.request.state.pending": "Waiting",
  "company.request.state.queried": "Queried",
  "company.request.state.lapsed": "No longer acceptable",
  "company.request.state.approved": "Approved",
  "company.request.state.withdrawn": "Withdrawn",
  "company.request.state.superseded": "Replaced",
  "company.request.waiting_on": "Waiting on {names}",
  "company.request.waiting_on_nobody": "Nobody on the team can approve this under the current rule.",
  "company.request.queried_by": "{name} asked a question, {date}",
  "company.request.approved_by": "Approved by {name}, {date}. The quote is accepted.",
  "company.request.withdrawn": "Withdrawn before anyone decided.",
  "company.request.superseded": "Replaced by a later request or an acceptance on the same enquiry.",
  "company.request.lapsed.accepted": "Another quote on this enquiry was accepted.",
  "company.request.lapsed.enquiry_closed": "The enquiry closed before anyone approved it.",
  "company.request.lapsed.quote_expired": "The quote expired before anyone approved it.",
  "company.request.lapsed.not_open": "The supplier withdrew this quote.",
  "company.request.lapsed.revised": "The supplier sent a later revision. Ask for approval of that one.",
  "company.request.lapsed.supplier_closed": "The supplier closed their account.",
  "company.request.approve": "Approve",
  "company.request.approve_title": "Approve {quote}?",
  "company.request.approve_body": "Approving accepts {quote} from {supplier} for {amount} on {raiser}'s behalf. {supplier} receives the contact details, the other suppliers are told the enquiry is closed, and it cannot be undone.",
  "company.request.approve_confirm": "Approve and accept",
  "company.request.query": "Query",
  "company.request.query_title": "Query {quote}",
  "company.request.query_description": "It goes back to the person who raised it with your question. Nothing is accepted.",
  "company.request.query_label": "Your question",
  "company.request.query_confirm": "Send question",
  "company.request.answer": "Answer",
  "company.request.answer_title": "Answer the query on {quote}",
  "company.request.answer_label": "Your answer",
  "company.request.answer_confirm": "Send answer",
  "company.request.withdraw": "Withdraw",
  "company.request.withdraw_title": "Withdraw the request for {quote}?",
  "company.request.withdraw_body": "Nobody will be asked to approve it. The quote stays open to accept or ask about again.",
  "company.request.withdraw_confirm": "Withdraw request",
  "company.request.counter": "{used} / {limit}",

  "company.history.eyebrow": "Recent changes",
  "company.history.none": "No changes recorded yet.",
  "company.history.all": "Full history",
  "company.history.change": "{field}: {was} → {now}",
  "company.history.empty_value": "none",
  "company.history.no_threshold": "no threshold",
  "company.history.company_created": "{actor} set up the company.",
  "company.history.details_changed": "{actor} changed the company details.",
  "company.history.address_added": "{actor} added the address {label}.",
  "company.history.address_changed": "{actor} changed the address {label}.",
  "company.history.address_archived": "{actor} archived the address {label}.",
  "company.history.default_address_changed": "{actor} made {label} the default address.",
  "company.history.member_invited": "{actor} invited {name} ({email}) as {role}.",
  "company.history.invite_resent": "{actor} sent the invitation to {email} again.",
  "company.history.invite_revoked": "{actor} revoked the invitation to {email}.",
  "company.history.member_joined": "{actor} joined as {role}.",
  "company.history.member_changed": "{actor} changed {name}'s seat.",
  "company.history.member_deactivated": "{actor} deactivated {name}.",
  "company.history.member_left": "{actor} left the company.",
  "company.history.rule_changed": "{actor} changed the approval rule.",
  "company.history.flag_on": "{actor} turned on “{flag}”.",
  "company.history.flag_off": "{actor} turned off “{flag}”.",
  "company.history.approval_requested": "{actor} asked for approval to accept {quote}.",
  "company.history.approval_approved": "{actor} approved {quote}. The quote is accepted.",
  "company.history.approval_queried": "{actor} queried {quote}.",
  "company.history.approval_answered": "{actor} answered the query on {quote}.",
  "company.history.approval_withdrawn": "{actor} withdrew the request for {quote}.",
  "company.history.approval_closed_left": "The request for {quote} closed when the person who raised it left.",
  "company.history.approval_lapsed": "The request for {quote} closed because the quote could no longer be accepted.",
  "company.history.approval_closed_accepted": "The request for {quote} closed when a quote on the same enquiry was accepted.",
  "company.history.approval_closed_replaced": "{actor} replaced the request for {quote} with a request about another quote.",
  "company.history.quote_accepted": "{actor} accepted {quote} within their own authority.",
  "company.history.unknown": "{actor} changed something on the company.",

  "company.invite_email.subject": "{inviter} invited you to join {company} on Business Listings",
  "company.invite_email.body": "{name}, {inviter} has invited you to join {company} on Business Listings as {role} ({authority}). You will send enquiries and accept quotes for the company, under its approval rule.",
  "company.invite_email.expiry": "The invitation expires on {date}. Sign in with this email address to accept it.",
  "company.invite_email.cta": "Accept the invitation",

  "company.join.expired": "This invitation has expired. Ask whoever invited you to send it again.",
  "company.join.revoked": "This invitation was revoked. Ask the company's admin if you still need a seat.",
  "company.join.used": "This invitation has already been accepted.",
  "company.join.wrong_account": "This invitation was sent to a different email address. Sign in with that address to accept it.",
  "company.join.other_company": "You already belong to another company. Leave it from Company & team first, then open this link again.",

  "company.error.signed_out": "Your session has ended. Sign in again to continue.",
  "company.error.generic": "That did not go through. Try again in a moment.",
  "company.error.not_done": "That did not go through.",
  "company.error.check_fields": "Some fields need attention. Each one says what is wrong.",
  "company.error.not_member": "You are not a member of a company on Business Listings.",
  "company.error.not_admin": "Only an admin of the company can change this.",
  "company.error.already_member": "You already belong to a company. Leave it before setting up another.",
  "company.error.provisional": "Finish creating your account first: a company needs a signed-in account to belong to.",
  "company.error.already_invited": "That address already has an invitation waiting. Resend it from the table instead.",
  "company.error.not_found": "That is no longer here. Reload the page to see the current state.",
  "company.error.too_soon": "The invitation was sent a few minutes ago. You can resend it 15 minutes after the last one.",
  "company.error.last_admin": "The company needs at least one admin. Make someone else an admin first.",
  "company.error.is_approver": "The rule names this person as its approver. Name another approver first.",
  "company.error.is_self": "To leave the company yourself, use Leave on your own row.",
  "company.error.approver_not_admin": "The approver has to be an active admin of the company.",
  "company.error.invalid_threshold": "Enter the threshold in whole dirhams, for example 25000, or leave it empty.",
  "company.error.threshold_too_large": "That is more than {max}. Check the number of zeros.",
  "company.error.area_mismatch": "That area is not in the emirate you chose.",
  "company.error.default_needs_replacement": "This is the default address. Make another address the default before archiving it.",
  "company.error.not_approver": "You cannot approve this one: nobody approves their own request, and the rule decides who approves the rest.",
  "company.error.approval_closed": "This request was already decided, withdrawn or replaced. Reload to see where it stands.",
  "company.error.approval_changed": "The quote is no longer at the value approval was asked for. Ask for approval again.",
  "company.error.note_required": "Write the question you want answered.",
  "company.error.answer_required": "Write your answer before sending it.",
  "company.error.note_too_long": "Keep it to 1,000 characters.",
  "company.error.not_queried": "There is no open question on this request.",
  "company.error.approval_required": "Your company's rule needs someone else to approve this quote. Send it for approval instead.",
  "company.error.po_required": "Your company requires a PO number to accept a quote.",
  "company.error.cost_code_required": "Your company requires a cost code to accept a quote.",
  "company.error.reference_invalid": "Keep the PO number and cost code to 40 characters each, typed rather than pasted from a spreadsheet.",
  "company.error.personal": "This enquiry was not sent for a company, so there is nobody to ask. Accept it directly.",
  "company.error.not_needed": "This quote is within your authority. Accept it directly.",
  "company.error.po_kept": "Your company requires a PO number on every accepted quote, so it can be corrected but not removed.",
  "company.record.delivery": "Delivery address",
  "contact.company.trn": "Buyer's TRN",
  "contact.company.licence": "Trade licence",
  "contact.company.accounts_email": "Send the tax invoice to",
  "contact.company.delivery": "Deliver to",
  "company.error.no_approver": "Nobody on your team can approve this under the current rule. An admin can change the rule or add an approver.",
  "company.approvals.title": "Approvals and spend",
  "company.approvals.back": "Back to {company}",
  "company.approvals.awaiting_you": "Waiting for your approval",
  "company.approvals.yours": "Your requests",
  "company.approvals.yours_none": "You have no requests waiting.",
  "company.approvals.others": "Waiting on others",
  "company.approvals.others_none": "Nothing is waiting on anyone else.",
  "company.approvals.decided": "Decided in the last 90 days",
  "company.approvals.decided_none": "Nothing decided in the last 90 days.",
  "company.approvals.people_title": "This month, by person",
  "company.approvals.people_description": "What each person has committed this calendar month, counted in Dubai time from the quotes they accepted and the requests they approved.",
  "company.approvals.people_caption": "Each person's spend authority, what they have used this month and what is left",
  "company.approvals.col.left": "Left this month",

  "company.approval_page.title": "Approval request",
  "company.approval_page.back": "All approvals",
  "company.approval_page.eyebrow": "{ref} · {quote}",
  "company.approval_page.heading": "{supplier} — {amount}",
  "company.approval_page.quote_title": "The quote",
  "company.approval_page.supplier": "Supplier",
  "company.approval_page.licence_verified": "Trade licence verified",
  "company.approval_page.licence_unverified": "Trade licence not verified",
  "company.approval_page.requirement": "What was asked for",
  "company.approval_page.valid": "Valid",
  "company.approval_page.valid_until": "Until {date}",
  "company.approval_page.valid_days": "{days} days from sending",
  "company.approval_page.terms": "Terms",
  "company.approval_page.po": "PO number",
  "company.approval_page.cost_code": "Cost code",
  "company.approval_page.lines_caption": "The quote's lines, excluding VAT",
  "company.approval_page.col.item": "Item",
  "company.approval_page.col.qty": "Qty",
  "company.approval_page.col.unit": "Unit price",
  "company.approval_page.col.total": "Line total",
  "company.approval_page.history_title": "What has happened",
  "company.approval_page.decide_label": "Deciding this request",
  "company.approval_page.decide_eyebrow": "Why it is here",
  "company.approval_page.note_from": "A note from {name}",
  "company.approval_page.who_approves": "Who may approve it: {names}.",

  "company.history.title": "Company history",
  "company.history.lede": "Every change to the company's details, addresses, team and rule, and every request and decision. Nothing here can be edited or removed.",
  "company.history.older": "Older changes",
  "company.history.pages_label": "History pages",

  "company.join.title": "Join a company",
  "company.join.eyebrow": "Invitation",
  "company.join.heading": "Join {company}",
  "company.join.body": "You are invited to join {company} as {role} ({authority}).",
  "company.join.body_named": "{inviter} has invited you to join {company} as {role} ({authority}).",
  "company.join.for": "Sent to",
  "company.join.expires": "Expires",
  "company.join.submit": "Join {company}",
  "company.join.sign_in": "Sign in to accept",
  "company.join.rule_note": "Once you join, quotes you accept on enquiries you send are governed by the company's approval rule.",
  "company.join.closed_title": "This invitation cannot be used",
  "company.join.unknown_title": "This link does not match an invitation",
  "company.join.unknown_body": "Check the link in the email, or ask whoever invited you to send it again.",

  "company.accept.title": "Accept a quote",
  "company.accept.back": "Back to the quotes",
  "company.accept.heading": "Accept {quote}",
  "company.accept.fee": "Fee",
  "company.accept.requested": "Sent for approval. Nothing is accepted until it is approved; you will hear by email either way.",
  "company.accept.not_member": "This enquiry was raised for {company}, and you no longer send enquiries for it, so it cannot be accepted in its name.",
  "company.accept.not_member_fix": "Re-send the requirement from My enquiries to raise it as your own.",
  "company.accept.open_eyebrow": "Waiting for approval",
  "company.accept.within_title": "Within your authority",
  "company.accept.within_admin": "As an admin of {company}, you accept this without anyone's approval.",
  "company.accept.within_limit": "You have {remaining} of your {limit} left this month, and this fits inside it.",
  "company.accept.releases": "Accepting releases your contact details to {supplier} and tells the other suppliers the enquiry is closed. It cannot be undone.",
  "company.accept.approval_title": "This goes to {names} for approval",
  "company.accept.approval_body": "Nothing is accepted and {supplier} is not told until it is approved. You hear by email when it is approved or queried.",
  "company.accept.nobody_title": "Nobody on your team can approve this",
  "company.accept.nobody_body": "The rule holds this quote and no colleague has the authority to approve it. An admin can change the rule or a colleague's role.",
  "company.accept.nobody_gap": "You are the approver the rule names, and nobody approves their own request. There is no second admin to approve it for you.",
  "company.accept.replaces": "Your request for {quote} on this enquiry is still open. Sending this one replaces it.",
  "company.accept.closes_request": "Your request for {quote} on this enquiry is still open. Accepting this quote closes it.",
  "company.accept.you": "you",
  "company.accept.po_hint": "Your PO number, as your accounts team files it. The supplier sees it on the accepted record.",
  "company.accept.cost_hint": "The budget line it is charged to.",
  "company.accept.note": "A note for the approver",
  "company.accept.send_for_approval": "Send for approval",
  "company.accept.submit": "Accept {quote} — {amount}",

  "company.notice.pending": "{quote} is with {names} for approval, since {date}.",
  "company.notice.queried": "{name} asked a question about {quote} before approving it.",
  "company.notice.lapsed": "The request for {quote} can no longer be approved.",
  "company.notice.open": "Open the request",
  "company.notice.thread_footnote": "Your company's approval rule applies: the next screen says whether this is within your authority or goes to a colleague.",
  ...
  */
  ...
  "alerts.event.quote_declined": "A buyer accepts another supplier's quote",
  "alerts.event.enquiry_nudged": "A buyer nudges you for a quote",
  ...
  */
  ...
  /*
     Its own word, rather than borrowing the plan table's row label.

     It said `admin.plans.col.products`, which is a heading on a different
     screen about a different thing — a cap — and renaming that row would have
     silently renamed a field on this one.
  */
  "admin.catalogue_imports.products": "Products",
  ...
  "admin.plans.matrix.title": "Entitlements per plan",
  "admin.plans.matrix.warning": "Changing a number here changes it for every account on that plan.",
  "admin.plans.col.entitlement": "Entitlement",
  "admin.plans.col.plan": "Plan",
  "admin.plans.col.accounts": "Accounts",
  "admin.plans.col.grandfathered": "On old numbers",
  "admin.plans.group.price": "Price",
  "admin.plans.group.caps": "Caps",
  "admin.plans.group.features": "Included",
  "admin.plans.group.sale": "On sale, and what an edit would move",
  "admin.plans.row.price": "Monthly price · AED, ex-VAT",
  "admin.plans.row.annual_months": "Months charged for a year",
  "admin.plans.row.annual_price": "A year costs",
  "admin.plans.row.enquiries": "Enquiries per month",
  "admin.plans.row.products": "Products",
  "admin.plans.row.services": "Services",
  "admin.plans.row.locations": "Branches",
  "admin.plans.row.photos": "Photos a seller may upload",
  "admin.plans.row.public_photos": "Photos a visitor is shown",
  "admin.plans.row.storage": "Storage",
  "admin.plans.row.categories": "Categories, including the primary one",
  "admin.plans.row.seats": "Team seats",
  "admin.plans.row.custom_domain": "Custom domain",
  "admin.plans.row.analytics": "Analytics",
  "admin.plans.row.csv": "CSV import",
  "admin.plans.row.sponsored": "Sponsored placement",
  "admin.plans.row.on_sale": "On sale",
  "admin.plans.on_sale_cell": "{plan} is on sale",
  "admin.plans.on": "Yes",
  "admin.plans.off": "No",
  "admin.plans.unlimited": "Unlimited",
  "admin.plans.unlimited_hint": "No cap",
  "admin.plans.monthly_only": "Monthly only",
  "admin.plans.monthly_only_hint": "No annual term",
  "admin.plans.withdrawn_badge": "Withdrawn",
  "admin.plans.withdrawn_on": "Withdrawn {when}",
  "admin.plans.grandfathering": "Reducing an entitlement affects the accounts counted above. Existing accounts are grandfathered on their current numbers unless you apply the change to them, which is the last step and states its own count.",
  "admin.plans.blank_cells": "These cells are empty and have no cap ticked: {cells}. A cap is a number or it is no cap — say which.",
  "admin.plans.review": "Review the change",
  "admin.plans.discard": "Put the numbers back",
  "admin.plans.nothing_to_review": "Those are the numbers it already has.",
  "admin.plans.confirm.title": "What this would do",
  "admin.plans.confirm.body": "Nothing is written until you save. Read the rows, then say why.",
  "admin.plans.confirm.caption": "Every field this change would move, and what this change would move it from",
  "admin.plans.confirm.from": "From",
  "admin.plans.confirm.to": "To",
  "admin.plans.confirm.reduction": "Lower",
  "admin.plans.confirm.accounts": "{count} live accounts are on the plans this touches.",
  "admin.plans.confirm.accounts_one": "One live account is on the plan this touches.",
  "admin.plans.confirm.accounts_none": "No live account is on the plans this touches.",
  "admin.plans.confirm.repriced_one": "One of them renews at the new price from its next renewal. A price is not part of what a seller is grandfathered on, so this happens whether or not you apply the change below.",
  "admin.plans.confirm.repriced": "{count} of them renew at the new price from their next renewal. A price is not part of what a seller is grandfathered on, so this happens whether or not you apply the change below.",
  "admin.plans.apply_label": "Apply to the {count} accounts already on these plans",
  "admin.plans.apply_label_one_plan": "Apply to the {count} accounts already on this plan",
  "admin.plans.apply_label_one_account": "Apply to the one account already on this plan",
  "admin.plans.apply_hint": "Off by default. A seller who signed up on forty enquiries a month keeps forty until somebody decides otherwise and says why. Applying it puts every one of them on the plan's numbers in full, including caps this change does not touch.",
  ...
  "admin.plans.commit": "Save the change to {count} plans",
  "admin.plans.commit_one": "Save the change",
  "admin.plans.commit_apply": "Save, and move {count} accounts",
  "admin.plans.commit_apply_one": "Save, and move one account",
  "admin.plans.back": "Back to the table",
  "admin.plans.saved": "Saved. {count} existing accounts moved onto the new numbers.",
  "admin.plans.saved_one_account": "Saved. One existing account moved onto the new numbers.",
  "admin.plans.saved_none": "Saved. Existing accounts keep the numbers they signed up on.",
  "admin.plans.add": "Add a plan",
  "admin.plans.add_title": "Add a plan",
  "admin.plans.add_body": "It starts withdrawn from sale, with the caps of the plan you copy. Nobody can choose it and no trial can start on it until you put it on sale, which is its own change with its own reason.",
  "admin.plans.add_confirm": "Add the plan",
  "admin.plans.add_id": "Id",
  "admin.plans.add_id_hint": "Lower-case letters, digits and hyphens — pro-plus, not Pro Plus. It reaches a URL, so it does not change afterwards.",
  "admin.plans.add_name": "Name",
  "admin.plans.add_name_hint": "What a seller reads on the pricing page.",
  "admin.plans.add_price": "Monthly price · AED, ex-VAT",
  "admin.plans.add_price_hint": "Whole dirhams. VAT is added as its own line wherever a total appears.",
  "admin.plans.add_copy": "Copy the caps from",
  "admin.plans.add_copy_hint": "Every cap and entitlement starts at this plan's values. Search ranking does not: a new plan starts at the bottom of the plan-tier weight, and that weight is set on the ranking screen.",
  "admin.plans.added": "Added {plan}, withdrawn from sale. Set its numbers, then put it on sale.",
  "admin.plans.not_yours": "Plan config is an ops lead or finance decision.",
  "admin.plans.needs_reason": "Say why in a sentence. It goes on the audit row with the numbers that moved.",
  "admin.plans.dunning_note": "One list, at failed payments. This is the count it holds.",
  "admin.plans.dunning_none": "Nobody is past due",
  "admin.plans.dunning_at_risk": "{count} past due · {amount} at risk, incl. VAT",
  "admin.plans.dunning_dropping": "{count} drop to Free within seven days",
  "admin.plans.dunning_dropped": "{count} have already dropped to Free, and are not in that figure",
  "admin.plans.dunning_link": "Open failed payments",
  "admin.plans.note": "Entitlements are data. Every cap on this page is a column, read at the point of use, and grandfathered per subscription — which is what makes the last step a real decision rather than a label. Lowering a cap below what a seller is already using never deletes anything: they choose what stays live and the rest is stored unlisted.",
  "admin.plans.ranking_note": "There is no ranking field here. Plan tier is one of six weights that always total 100, capped at 10, and search ranking is set on the ranking screen — a second control for it in billing would be a second writer for the same model.",
  "admin.plans.buyer_side_note": "The free enquiry allowance reaches further than this table. A free-plan supplier who has used it is left out of the RFQ fan-out without being told, because a buyer is not shown a supplier who cannot reply — so this number decides who receives demand, not only what a seller may send.",
  ...
  "admin.dunning.eyebrow": "Billing operations",
  "admin.dunning.meta": "{count} in the sequence · {amount} at risk, incl. VAT",
  "admin.dunning.meta_none": "Nobody is past due",
  "admin.dunning.meta_all_dropped": "{count} finished the sequence and are on Free. Nobody is past due.",
  ...
  "admin.dunning.col.amount": "Amount, incl. VAT",
  "admin.dunning.col.reason": "Reason",
  "admin.dunning.col.drops": "Drops to Free",
  ...
  "admin.dunning.no_reason": "nothing tried yet",
  "admin.dunning.drops_in": "in {when}",
  "admin.dunning.drops_on": "on {when}",
  "admin.dunning.already_dropped": "already on Free",
  ...
  "admin.commerce.tabs_label": "Billing operations",
  "admin.commerce.tab.plans": "Plans & entitlements",
  "admin.commerce.tab.dunning": "Failed payments",
  "admin.commerce.tab.invoices": "Invoices & credits",
  ...
  "notifications.opt_out.floor_list": { one: "One message ignores the choice: {events}.", other: "{count} messages ignore the choice: {events}." },
  ...
  // Board `1n`: in-app only, and the answer to work the seller already has open.
  "notifications.floor_event.quote_declined": "a quote the buyer did not accept",
  "notifications.floor_event.enquiry_nudged": "a buyer's nudge",
  ...
  // Missing since board `11e` put the slot on the floor: the quiet-hours page
  // printed this key rather than a title.
  "notifications.floor_title.placement_slot_freed": "A sponsored slot coming free",
  "notifications.floor_title.quote_declined": "A quote the buyer did not accept",
  "notifications.floor_title.enquiry_nudged": "A buyer's nudge",
  ...
  */
  ...
  "catalogue.compare_prompt": "Comparing specs across sellers? Tick Compare on up to four products in one trade and they line up field by field.",
  "catalogue.compare_cta": "Open the comparison",
