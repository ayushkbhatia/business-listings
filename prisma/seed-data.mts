...
export const PLANS = [
  ...
  { id: "basic", name: "Basic", monthlyPriceAed: 349, enquiriesPerMonth: 40, productLimit: 150, locationLimit: 3, photoLimit: 40, publicPhotoLimit: null, storageMb: 300, teamSeats: 3, categoryLimit: 3, rankingMultiplier: 1.15, customDomain: false, analytics: true, csvImport: true, sponsoredEligible: false, sortOrder: 1, annualMonthsCharged: 10 },
  { id: "pro", name: "Pro", monthlyPriceAed: 899, enquiriesPerMonth: null, productLimit: null, locationLimit: 10, photoLimit: 200, publicPhotoLimit: null, storageMb: 500, teamSeats: 10, categoryLimit: null, rankingMultiplier: 1.35, customDomain: true, analytics: true, csvImport: true, sponsoredEligible: true, sortOrder: 2, annualMonthsCharged: 10 },
] as const;
