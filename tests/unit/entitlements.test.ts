...
const FREE: PlanCaps = {
  ...
  locationLimit: 1, photoLimit: 5, storageMb: 1024, teamSeats: 1, rankingMultiplier: 1, customDomain: false,
  sortOrder: 0,
};
const BASIC: PlanCaps = {
  id: "basic", name: "Basic", monthlyPriceAed: 349, enquiriesPerMonth: 40, productLimit: 150,
  locationLimit: 3, photoLimit: 40, storageMb: 1024, teamSeats: 3, rankingMultiplier: 1.15, customDomain: false,
  sortOrder: 1,
};
const PRO: PlanCaps = {
  id: "pro", name: "Pro", monthlyPriceAed: 899, enquiriesPerMonth: null, productLimit: null,
  locationLimit: 10, photoLimit: 200, storageMb: 1024, teamSeats: 10, rankingMultiplier: 1.35, customDomain: true,
  sortOrder: 2,
};
